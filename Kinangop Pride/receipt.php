...
<div class="container-fluid">
	<p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Kinangop Pride Junior Academy" : 'Kinangop Pride Junior Academy' ?></b></p>
	<hr>
	<center>
	<img src="/Kinangop Pride/logo.jpg" alt="logo" width="100" height="100">
    </center>
	<br>
	<div class="flex">
		<div class="w-50">
