...
<nav class="navbar navbar-light fixed-top bg-primary" style="padding:0">
  <div class="container-fluid mt-2 mb-2">
      ...
      <img src="./logo.jpg" alt="logo" height="30" width="30">
        <large><b>Kinangop Pride Academy</b></large>
      </div>
...
<script>
  $('#manage_my_account').click(function(){
    uni_modal("Manage Account","manage_user.php?id=<?php echo $_SESSION['id'] ?>&mtype=own")
  })
</script>