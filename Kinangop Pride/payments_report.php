...
$('#print').click(function(){
        ...
        nw.document.write('<p class="text-center"><b>Kinangop Pride Junior Academy</b></p><br>')
        nw.document.write('<center><img src="./logo.jpg" height="100" width="100"></center><br>')
		nw.document.write('<p class="text-center"><b>Payment Report as of <?php echo date("F, Y",strtotime($month)) ?></b></p><br>')
